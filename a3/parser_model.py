...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.linear_layer1 = nn.Linear(self.n_features*self.embed_size,self.hidden_size)
        nn.init.xavier_uniform_(self.linear_layer1.weight,gain = 1)
        self.dropout_layer = nn.Dropout(p = self.dropout_prob)
        self.linear_layer2 = nn.Linear(self.hidden_size,self.n_classes)
        nn.init.xavier_uniform_(self.linear_layer2.weight,gain = 1)
        ### END YOUR CODE
    ...
    def embedding_lookup(self, t):
        ...
        t_ = torch.LongTensor(t)
        x = self.pretrained_embeddings(t_)
